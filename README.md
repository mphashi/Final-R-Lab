...
| `CP3.R` | Checkpoint 3 analysis script |
| `CP2_Script_COMPLETE.R` | Checkpoint 2 analysis script (.R version) |
| `CP2 Script COMPLETE.Rmd` | Checkpoint 2 analysis script (R Markdown version) |
| `README.md` | This file |
| `.gitignore` | Excludes large files and R-specific artifacts |
